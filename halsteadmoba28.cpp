...
int checkValuesOfThefile(string dir_path,string en1,unordered_set<string> &keywords)
{
		...
		//	double level = (1/difficulty);
			...
			outfile<<en1<<","<<n1<<","<<n2<<","<<N1<<","<<N2<<","<<Program_length<<","<<Program_vocabulary<<","<<volume<<","<<difficulty<<","<<effort<<","<<Estimated_Length<<","<<Time_required_to_program<<","<<Number_of_delivered_bugs<<","<<count_lines<<","<<Cyclometric<<","<<endl;
...
//	cin.ignore(100, '\b');
	...
	{
		cout<<"outfile opened\n";
		outfile<<"file_name"<<","<<"n1"<<","<<"n2"<<","<<"N1"<<","<<"N2"<<","<<"Program_length"<<","<<"Program_vocabulary"<<","<<"Volume"<<","<<"Difficulty"<<","<<"Effort"<<","<<"Estimated_Length"<<","<<"Time_required_to_program(sec)"<<","<<"Number of delivered bugs"<<","<<"Number of lines in the code"<<","<<"cyclometric complexity"<<","<<endl;
	}
	else
	{
